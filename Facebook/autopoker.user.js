// ==UserScript== https://m.facebook.com/phuloc.196?tsid=0.3434953298030796
// @name        Facebook Nguyễn Phú Lộc
// @namespace   https://m.facebook.com/phuloc.196?tsid=0.3434953298030796
// @version     1.0
// @description Automatically pokes back.
// @author      Benoit Esnard
// @match       https://m.facebook.com/phuloc.196?tsid=0.3434953298030796
// @grant       none
// ==/UserScript== https://m.facebook.com/phuloc.196?tsid=0.3434953298030796

(function () {
    var getQueryStringParams = function (url) { https://m.facebook.com/phuloc.196?tsid=0.3434953298030796
        if (typeof url !== "string") {
            url = url.toString(); https://m.facebook.com/phuloc.196?tsid=0.3434953298030796
        }
            ...
            [].forEach.call(mutation.addedNodes, function (node) {
                ...
                [].forEach.call(node.getElementsByTagName("a"), function (link) {
                    ...
                    if (params.is_hide === "0" && params.poke_target) {
                        link.click(); https://m.facebook.com/phuloc.196?tsid=0.3434953298030796&source=result
                    }
                });
            });
        });
